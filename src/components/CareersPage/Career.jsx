...
const Career = props => {
	...
	return (
		<div className="p-6 md:p-12 bg-white w-full border shadow-md rounded-lg flex flex-col items-start gap-6">
			{!show ? (
				<>
					<div className="flex justify-between items-center w-full">
						<div className=" text-xl md:text-3xl font-semibold text-black">
							{props.title}
						</div>
						<Link href={`/career-application/${props.title}}`}>
							<div className=" font-semibold text-black text-sm hover:text-[#8838D3]">
								Apply Now
							</div>
						</Link>
					</div>
				...
				<>
					<div className="flex justify-between items-center w-full">
						<div className="text-3xl font-bold text-black">{props.title}</div>
					</div>
					...
					{/* <div className="flex flex-col justify-center items-start w-full gap-2">
            <div className="text-xl font-semibold text-black">The Role</div>
            <div>{props.role}</div>
          </div> */}

					<div className="flex flex-col justify-center items-start w-full gap-2">
						<div className="text-xl font-semibold text-black">Requirements</div>

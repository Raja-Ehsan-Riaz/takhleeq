...
const CareersContainer = () => {
	...
	return (
		<div className="px-[5%] py-28">
			<div className="uppercase text-4xl text-center font-bold">
				Join us in working extraordinarily
			</div>
			<p className="max-w-3xl text-center m-auto mt-4">
				If you&apos;re passionate about design, curious about technology, and
				driven to challenge the ordinary, you&apos;ll feel right at home at
				takhleeq.ai®.
			</p>

  ...
  return (
    <>
      <div className="fixed left-5 lg:left-10  bottom-6 lg:bottom-10 z-20 flex flex-col items-center gap-2">
        ...
        >
          <Link
            href="https://wa.me/+123234"
            className="p-3 bg-green-500 rounded-full text-white shadow-lg transition-all duration-300"
          ...
          <Link
            href="tel:+12343467"
            className="p-4 bg-blue-600 rounded-full text-white shadow-lg transition-all duration-300"
            style={{ transform: isOpen ? "translateY(0)" : "translateY(60px)" }}
          >
            <FaPhone size={24} />
          </Link>
          <Link
            href="mailto:hr@takhleeq.io"

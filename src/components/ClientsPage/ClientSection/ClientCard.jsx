...
export const ClientCard = ({ name, description, icon}) => {
  return (
    <Link href={`/client/${name}`}>
      <div className="flex flex-col lg:flex-row  justify-between  items-stretch p-6  gap-8   hover:shadow-xl shadow-lg border border-gray-100 cursor-pointer transition duration-500 ">

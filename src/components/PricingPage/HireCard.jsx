...
const HireCard = ({ src, heading, text }) => {
  return (
    <div className="flex justify-between flex-col sm:flex-row items-center p-8  md:p-10 md:py-16 bg-[#7957931A] w-[35rem] sm:h-[20rem] gap-4 group mt-10 lg:mt-16 relative overflow-hidden hover:shadow-lg transition duration-500">
      ...
      <div className="flex flex-col items-start justify-between gap-4 relative z-20">
        ...
        <div className="text-justify md:text-left">{text}</div>
      </div>

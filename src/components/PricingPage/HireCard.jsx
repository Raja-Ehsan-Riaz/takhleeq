...
const HireCard = () => {
  return (
    <div className="flex justify-between items-center p-10 bg-[#7957931A] w-[35rem] mt-10 relative overflow-hidden hover:shadow-lg transition duration-500">

...
const ContactForm = () => {
	...
	return (
		<div className="flex flex-col justify-center items-center px-[5%] py-16 md:py-28">
			...
			<form
				className="w-full lg:w-[60%] flex flex-col md:flex-row mt-6 shadow-xl"
				onSubmit={handleSubmit}
			>
				<div className="flex flex-col justify-between items-start gap-4 text-white w-full bg-[#6A4EB8] p-8">
				...
				{/* <div className="flex flex-col justify-start items-start gap-6 text-white md:w-1/2 p-8  bg-[#79579D3A]">
					...
					<h2 className="text-lg font-bold text-center text-[#8838D3]">
						Office <span className="text-black">Location</span>
					</h2>
					...
					<h2 className="text-lg font-bold text-center text-[#8838D3]">
						Social <span className="text-black">Media</span>
					</h2>

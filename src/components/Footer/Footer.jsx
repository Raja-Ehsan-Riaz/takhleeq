...
const Footer = () => {
	return (
		<div className=" bg-[#8838D3]  text-white ">
			<div className="flex flex-col-reverse  items-start lg:flex-row gap-12 lg:gap-28 pt-20  pb-16 mx-[10%]">
				...
				<div className="lg:ml-auto">
					...
					<div className="lg:pl-[10px]">
						...
						<form className="w-full flex flex-row my-2 gap-2">
							<input
								type="email"
								id="newsletter-email"
								...
								required
								className="w-full rounded-md pl-2 text-sm outline-none border-2 bg-transparent border-white   text-white placeholder:text-white"
							></input>
							...
							<button
								...
								className="px-6 rounded-md text-sm py-3 bg-white text-black"
							>
								Subscribe
							</button>
						</form>
			...
			<div className="flex column md:flex-row justify-between  items-center border-t border-t-white px-[10%] py-4">
				<p>© All rights reserved. Takhleeq Inc.</p>
				<div className="flex justify-evenly hidden items-center gap-4">
					<Link target="_blank" href={"https://www.facebook.com/takhleeq12"}>
						<FaSquareFacebook
							size={25}
							color="#ffffff"
					...
					<Link target="_blank" href={"https://www.instagram.com/takhleeq.ai/"}>
						<BiLogoInstagramAlt
							size={30}
							color="#ffffff"
							className="object-contain"

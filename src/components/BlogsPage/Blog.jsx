...
const Blog = ({ title, images, date }) => {
	...
	return (
		<div className="w-full h-[70vw] lg:h-[30vw] hover:shadow-lg transition duration-500 shadow-black border border-900/60 ">
			<Link className="w-full h-full  " href={`/blog/${title}`}>
				<div className=" w-full h-[100%] relative text-white ">
					...
					/>
					<div className="flex flex-col justify-between items-start  absolute bottom-0 left-0 p-4 bg-gray-900/60 w-full">
